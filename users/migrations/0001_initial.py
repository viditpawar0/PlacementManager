    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_pursuing', models.CharField(blank=True, choices=[('computer_science', 'Computer Science'), ('data_science', 'Data Science'), ('business_management', 'Business Management'), ('mechanical_engineering', 'Mechanical Engineering'), ('electrical_engineering', 'Electrical Engineering'), ('civil_engineering', 'Civil Engineering'), ('biotechnology', 'Biotechnology'), ('economics', 'Economics')], help_text='Course the student is pursuing', max_length=50, null=True)),
